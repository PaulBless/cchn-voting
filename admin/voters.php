...
//fetch voter list
$voters = new Voters();
$fetch_results = $voters->getVoterList();
## -----------------------------------------
 ...
 <!-- MAIN WRAPPER -->
    <div id="wrap" >
       ...
       <?php include('top.php') ?>
        ...
        <div id="content">
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-lg-12">
                       <!--page title/section-->
                        <h5><span class="fa fa-home"></span> E-Voting <i class="fa fa-chevron-right"></i> Voters <i class="fa fa-chevron-right"></i> Voters List </h5>
                    </div>
                </div>
                  <hr />
                ...
                <div class="box">
                    <header>
                        <div class="icons"><i class="fa fa-list-ul"></i></div>
                        <h5>VOTERS LIST</h5>
                    ...
                    <div class="panel panel-default">
                        ...
                        <a href="" target="_self" data-toggle="modal" data-target="#regAdmin" class="btn btn-primary btn-rect" style="font-weight: bold; float: right; margin: 5px 5px 5px 5px;"><i class="fa fa-plus"></i> Add Voter</a>
						<br>
                       <div class="panel-body" style="margin-top: 10px;">
                        ...
                        <th data-field="fullname">Name of Voter</th>
                        <th data-field="gender">Gender</th>
                        <th data-field="mobile">Mobile No</th>
                        <th data-field="position">Course</th>
        ...
        <?php
            $bool = false; //set flag
            $query1=mysqli_query($connect_db, "SELECT * from `voters` ORDER BY `name` ASC");
            $cnt=1;
		
            while($records=mysqli_fetch_array($query1)){
            $voters_id = $records['voterid']; //get voter id 
        ?>
                <tr>
                <td><?php echo $cnt; ?></td>
                 <td class="hidden"><?php echo $records['voterid'] ?></td>
                <td><?php echo $records['name']; ?></td>
                <td><?php echo $records['gender']; ?></td>
                <td><?php echo $records['phoneno']; ?></td>
                <td><?php echo $records['course']; ?></td>
                <td class=""><?php echo $records['createdby']; ?></td>
                <td class="datatable-ct">
                  
                <!--update link-->
                 <a title="Click to update" class="btn btn-info btn-sm" id="<?php echo $records['voterid']; ?>" href="#edit_voter<?php echo $records['voterid']?>" data-toggle="modal"> <i class="fa fa-edit"></i> Edit </a>
                 <?php require('modal/edit_voter.php'); ?>
                 <!-- delete link -->
                 <a title="Click to delete" class="btn btn-danger btn-sm" href="delete-voter.php?voterid=<?php echo htmlentities($records['voterid']);?>" onclick="return confirm('Do you really want to delete this voter, <?php echo htmlentities($records['name']) ?> record from the system?')"> <i class="fa fa-trash"></i> Delete </a>
