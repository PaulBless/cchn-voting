    ...
    <div id="wrap" >
        ...
        <div id="top">
            <nav class="navbar navbar-inverse navbar-fixed-top " style="padding-top: 10px;">
                ...
                <!--app name/title-->
               <a class="app-name"> Voting System</a>
                <!-- add search button-->
                </header>
                <!-- END LOGO SECTION -->
        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-lg-12">
                       <!--page title/section-->
                        <h5><span class="fa fa-home"></span> E-Voting <i class="fa fa-chevron-right"></i> Main Menu <i class="fa fa-chevron-right"></i> Committee Decisions on Applications <i class="fa fa-chevron-right"></i> Approval Remarks</h5>
                    </div>     
                </div>
