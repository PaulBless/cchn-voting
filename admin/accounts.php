        ...
        <div id="content">
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-lg-12">
                       <!--page title/section-->
                        <h5><span class="fa fa-home"></span> E-Voting <i class="fa fa-chevron-right"></i> Accounts <i class="fa fa-chevron-right"></i> User List </h5>
                    </div>
                </div>
                  <hr />
                ...
                <div class="box">
                    ...
                    <div class="panel panel-default">
                        ...
                        <a href="" target="_self" data-toggle="modal" data-target="#regAdmin" class="btn btn-primary btn-rect" style="font-weight: bold; float: right; margin: 5px 5px 5px 5px;"><i class="fa fa-plus"></i> Add New User</a>
						<br>
                       <div class="panel-body" style="margin-top: 10px;">
                        <div class="panel panel-default">

                            <div class="panel-heading hidden" style="text-align: center; font-size: 16px; font-weight: bold; color:#007bff;"><i class="" ></i>  Admin Accounts</div>
