...
<body class="page-forgot-pwd" onload=""> 
    ...
    <div class="forgot-password-container d-flex align-items-center justify-content-center">
       <!-- begin login form--> 
        ...
        <div class="logo"><img src="../assets/images/logo.png" width="100" height="100"/><span style="display: block"><h4 class="app-title" style="font-size: 16px">Voting System</h4></span>
