    ...
    <div id="wrap" >
       ...
       <?php include('top.php') ?>
        ...
        <div id="content">
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-lg-12">
                       <!--page title/section-->
                        <h5><span class="fa fa-home"></span> E-Voting <i class="fa fa-chevron-right"></i> Report <i class="fa fa-chevron-right"></i> Votes Casted  </h5>
                    </div>
                </div>
                  <hr />
        ...
        <?php
            ...
            //$query1=mysqli_query($connect_db, "SELECT *, `candidates.name`, `candidates.position`, `voters.name` FROM `vote_cast` LEFT JOIN `candidates` ON `candidates.candidateid=vote_cast.candidate_id` LEFT JOIN `voters` ON `voters.voterid=vote_cast.voter_id` ORDER BY `candidates.position` ASC");
            $cnt=1;
